...
# #### Observation
# - we should have to ignore the diagonal
# - The highest correlation strength is observered between Ozone and Temperature(o.597087)
# - The next highest correlation strength is observered between Ozone and Wind(-0.523738)
# - The  next highest correlation strength is observered between wind and Temp(-0.441228)
# - The least correlation strength is observed between solar and wind (-0.057709)
